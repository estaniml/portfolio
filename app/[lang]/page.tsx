      ...
      <div className='mt-16 pt-8'>
        ...
        <div className='grid grid-cols-2'>
          ...
          <div className='grid grid-cols-1 gap-2 md:gap-0 md:grid-cols-2'>
            <a href='https://www.linkedin.com/in/emartinezlacabe/' target='_blank' rel='noreferrer' className='flex justify-center items-center gap-2 bg-stone-800 text-white w-[90%] mx-auto rounded-lg border border-stone-900 hover:opacity-90 transition-all shadow font-medium'>
              <Linkedin size={16} />
              LinkedIn 
            </a>
