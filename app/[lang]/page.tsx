  ...
  return (
    <main className="relative min-h-screen w-full md:w-3/6 md:mx-auto px-2 md:px-0 pt-12 mt-12 pb-10 bg-lines">
      ...
      <div className="mt-16 pt-8">
        ...
        <Link
          className="mt-8 w-full flex justify-center items-center gap-1 hover:gap-2 transition-all"
          href="/projects/all"
        >
          {home.seeMore} <ChevronRight size={16} />{" "}
        </Link>
      </div>
      ...
      <div className="mt-16 pt-8">
        ...
        <div className="grid grid-cols-2">
          <div className="w-[90%]">
            <h3 className="text-lg md:text-xl text-stone-600 dark:text-stone-400 font-light">
          ...
          <div className="grid grid-cols-1 gap-2 md:gap-0 md:grid-cols-2">
            <a
              href="https://www.linkedin.com/in/emartinezlacabe/"
              target="_blank"
              rel="noreferrer"
              className="flex justify-center items-center gap-2 bg-stone-800 text-white w-[90%] mx-auto rounded-lg border border-stone-900 hover:opacity-90 transition-all shadow font-medium"
            >
              <Linkedin size={16} />
              LinkedIn
            </a>
            <a
              href="mailto:emartinezlacabe@gmail.com"
              target="_blank"
              rel="noreferrer"
              className="flex justify-center items-center gap-2 bg-stone-50 text-black w-[90%] mx-auto rounded-lg border border-stone-300 hover:bg-stone-100 transition-all shadow font-medium"
            >
              <Mail size={16} />
              Email
            </a>
